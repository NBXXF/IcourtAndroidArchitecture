 ...
 */
public abstract class ICourtSelectableBindingAdapter<VDB extends ViewDataBinding, T extends IICourtSelectableEntity>
        extends ICourtBindingAdapter<VDB, T> implements IICourtSelectableAdapter {
    ...
    public ICourtSelectableBindingAdapter(@SelectType int selectType) {
        this.selectType = selectType;
    }

    public ICourtSelectableBindingAdapter(@SelectType int selectType, @NonNull List<T> data) {
        super(data);
        this.selectType = selectType;
    }
