...
public abstract class ICourtFragment<T extends ViewDataBinding>
        extends ICourtHttpFragment
        implements IICourtBinding<T>, IICourtToast, IICourtProgressHUD {
    private static final String TAG = ICourtFragment.class.getSimpleName();
    private T binding;
